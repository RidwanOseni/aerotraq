    ...
    <>
      <div className="space-y-4">
        <h4 className="font-medium flex items-center gap-2">
          <Drone className="h-4 w-4" /> Drone Details
        </h4>
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="e.g., SkyExplorer" {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="e.g., DJI Mavic 3" {...field} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>Must be alphanumeric</FormDescription>
              <FormMessage />
            </FormItem>
          )}
        />
      ...
      <div className="space-y-4">
        <h4 className="font-medium flex items-center gap-2">
          <MapPin className="h-4 w-4" /> Flight Plan
        </h4>
        <FormField
          control={form.control}
          name="flightPurpose"
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>What is the primary purpose of this flight?</FormDescription>
              <FormMessage />
            </FormItem>
          )}
        />
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    <FormControl>
                      ...
                      >
                        {/* Changed date format from "PPP" to "yyyy-MM-dd" for consistency [7, 12] */}
                        {field.value ? format(new Date(field.value + 'T00:00:00'), "yyyy-MM-dd") : <span>Pick a date</span>}
                ...
                <FormControl>
                  <Input
                    ...
                    value={typeof field.value === 'object' && field.value !== null && 'latitude' in field.value
                      ...
                      : (field.value === undefined || field.value === null ? '' : field.value as any)
                    }
                  />
                </FormControl>
